...
(function (factory) {
  ...
  $.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
    ...
    _create: function () {
      ...
      // if we have a sugarmaple with expanding/collapsing functionality,
      ...
      // prepare the sugarmaple by applying the right classes
    ...
    _mouseStop: function (event) {
      ...
      $.ui.sortable.prototype._mouseStop.apply(this, arguments); //asybnchronous execution, @see _clear for the
                                                                 // relocate event.
    },
